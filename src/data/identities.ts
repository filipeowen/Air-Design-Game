...
const AIRCRAFT_IDENTITIES: IdentitySet<AircraftIdentity> = {
  real_world: [
    ...
    aircraft("boeing-767", "Boeing 767", "767", "player", "wide-body", 1982),
    aircraft("boeing-757", "Boeing 757", "757", "player", "narrow-body", 1983),
    aircraft("boeing-777", "Boeing 777", "777", "player", "wide-body", 1995),
    aircraft("boeing-787", "Boeing 787", "787", "player", "wide-body", 2011),
    ...
    aircraft("mcdonnell-douglas-md-11", "McDonnell Douglas MD-11", "MD-11", "pacific-aeroworks", "wide-body", 1990),
    aircraft("boeing-717", "Boeing 717", "717", "pacific-aeroworks", "narrow-body", 1999),
    ...
    aircraft("airbus-a340", "Airbus A340", "A340", "meridian-aviation", "wide-body", 1993),
    aircraft("airbus-a321", "Airbus A321", "A321", "meridian-aviation", "narrow-body", 1994),
    aircraft("airbus-a330", "Airbus A330", "A330", "meridian-aviation", "wide-body", 1994),
    aircraft("airbus-a319", "Airbus A319", "A319", "meridian-aviation", "narrow-body", 1996),
    aircraft("airbus-a380", "Airbus A380", "A380", "meridian-aviation", "wide-body", 2007),
    aircraft("airbus-a350", "Airbus A350", "A350", "meridian-aviation", "wide-body", 2015),
    ...
    aircraft("fokker-70", "Fokker 70", "70", "noord-aviation", "regional-jet", 1994),
    aircraft("embraer-110", "Embraer EMB 110", "EMB 110", "atlantico-aeronautics", "regional-jet", 1973),
    ...
    aircraft("embraer-e170", "Embraer E170", "E170", "atlantico-aeronautics", "regional-jet", 2004),
    aircraft("embraer-e190", "Embraer E190", "E190", "atlantico-aeronautics", "regional-jet", 2005),
    ...
    aircraft("tupolev-tu-204", "Tupolev Tu-204", "Tu-204", "sunrise-heavy", "narrow-body", 1995),
    aircraft("bombardier-crj100", "Bombardier CRJ100", "CRJ100", "bombardier", "regional-jet", 1992),
    aircraft("bombardier-crj700", "Bombardier CRJ700", "CRJ700", "bombardier", "regional-jet", 2001),
    aircraft("bombardier-crj900", "Bombardier CRJ900", "CRJ900", "bombardier", "regional-jet", 2003),
    aircraft("bombardier-cseries-cs100", "Bombardier CSeries CS100", "CS100", "bombardier", "narrow-body", 2016),
    aircraft("bombardier-cseries-cs300", "Bombardier CSeries CS300", "CS300", "bombardier", "narrow-body", 2016),
    aircraft("ilyushin-il-62", "Ilyushin Il-62", "Il-62", "ilyushin", "narrow-body", 1967),
    aircraft("ilyushin-il-86", "Ilyushin Il-86", "Il-86", "ilyushin", "wide-body", 1980),
    aircraft("ilyushin-il-96", "Ilyushin Il-96", "Il-96", "ilyushin", "wide-body", 1992),
